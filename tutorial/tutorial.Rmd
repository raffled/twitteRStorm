...
```{r save.twitter.cred, echo = FALSE, eval = FALSE}
#### Can't dynamically authorize while knitting document, so we need to save credentials
#### to make the formatted document.
#### This saves twitCred to a binary file R can load while knitting
save(twitCred, file = "twitCred.bin")
```

```{r load.twitter.cred, echo = FALSE}
